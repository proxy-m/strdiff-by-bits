...
/**
 * Побитовое сравнение классических C-строк (завершающихся '\0').
 * @a - первая строка
 * @b - вторая строка
 * @returns
 *   n  - количество одинаковых бит (номер бита, начиная с 0, не включительно до которого строки равны)
 *   -1 - если строки равны побитово
 *   < -1 (например -2) - код ошибки, в случае некорректного ввода
 */
